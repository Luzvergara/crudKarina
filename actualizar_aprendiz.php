...
// actualizar aprendiz
  ...
  $resulado=consulta($miconexion,"update aprendices set  Apre_id='{$vide}',Apre_nombres='{$vnombres}',Apre_apellidos='{$vapellidos}',Apre_direccion='{$vdireccion}',Apre_telefono='{$vtelefono}'	where Apre_id='{$vide}'");
